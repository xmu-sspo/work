 ...
 * Generated at: 2018-07-26 07:03:15 UTC
...
public final class table_005fbasic_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t    <tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t        <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t            <td>Amaze UI</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t            <td>http://amazeui.org</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t            <td>2012-10-01</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t        </tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t        <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t            <td>Amaze UI</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t            <td>http://amazeui.org</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"card-box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- col start -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<table class=\"am-table  am-table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t\t    <thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t        <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t            <th>网站名称</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t            <th>网址</th>\r\n");
